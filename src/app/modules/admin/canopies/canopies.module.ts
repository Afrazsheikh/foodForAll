...
import { canopiesRoutes } from 'app/modules/admin/canopies/canopies.routing';
...
@NgModule({
    declarations: [
        CanopiesComponent,
        CanopiesListComponent
    ],
    imports     : [
        RouterModule.forChild(canopiesRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
