...
import { Donations, DonationsPagination } from 'app/modules/volunteer/orders/orders.types';
import { OrdersService } from 'app/modules/volunteer/orders/orders.service';
    ...
    styles: [
        ...
        `
            .orders-grid {
                ...
                @screen lg {
                    grid-template-columns: 50px 150px 250px 150px 150px 150px;
                }
            }
        `
    ],
